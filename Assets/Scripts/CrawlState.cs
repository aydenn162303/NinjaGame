...
public class CrawlState : PlayerBaseState
{
    ...
    public CrawlState(PlayerStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Enter()
    {
        ...
        if (stateMachine.Animator != null) {
            stateMachine.Animator.Play("Crawl");
        }
        Debug.Log($"[CrawlState] Entering Crawl State at {enterTime:F2}s");
